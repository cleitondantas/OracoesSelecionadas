...
INSERT or replace INTO GRUPO (TITULO,IDGRUPO) VALUES ('Cura',2);
INSERT or replace INTO GRUPO (TITULO,IDGRUPO) VALUES ('Libertação',3);
...
INSERT or replace INTO GRUPO (TITULO,IDGRUPO) VALUES ('Maria',9);
...
<br/>
<b>
"Disse-lhe Jesus: Eu sou a ressurreição e a vida. Aquele que crê em mim, ainda que esteja morto, viverá. E todo aquele que vive e crê em mim, jamais morrerá."(Jo 11,25-26)
</b>
',3);
...
INSERT or replace INTO ORACAO (TITULO,ORACAO,IDORACAO) VALUES (' Quaresma de São Miguel Arcanjo','A quaresma de São Miguel Arcanjo foi difundida através dos discípulos de São Francisco, que o imitavam nessa dvoção e recebiam graças. E até hoje, temos esse belíssimo costume de consagrar nossas vidas a São Miguel. 
...
A Quaresma de São Miguel Arcanjo tem seu início no dia 15 de agosto. No dia 20 de setembro inicia-se a novena em honra à São Miguel Arcanjo juntamente com as outras orações culminando com a grande festa no dia 29 de setembro. 
...
Durante as orações (40 dias ), Acender a vela (benta), fazer o sinal da Cruz.
...
<br/>
<br/>
<b>ORAÇÃO INICIAL PARA TODOS OS DIAS.</b>
<br/>
<br/>
<b>ORAÇÃO DE SÃO MIGUEL ARCANJO.</b>
...
<br/>
São Miguel Arcanjo, defendei-nos no combate para que não pereçamos no supremo juízo.',5);


INSERT or replace INTO ORACAO (TITULO,ORACAO,IDORACAO) VALUES ('Terço da Cruzada','
...
INSERT or replace INTO ORACAO (TITULO,ORACAO,IDORACAO) VALUES ('LADAINHA DE NOSSA SENHORA','
...
INSERT or replace INTO ORACAO (TITULO,ORACAO,IDORACAO) VALUES ('Ladainha do Imaculado Coração de Maria','
...
Oh! Maria, Mãe de Deus e nossa Mãe,
 ...
 ao Vosso Coração Imaculado consagramos nossa vida,
 todo nosso ser, tudo o que temos, tudo o que amamos,
 tudo o que somos. A Vós pertencem nossos lares, nossa pátria.
 <br/>
 <br/>
 Queremos que seja vosso, e participe dos benefícios de vossas bençãos maternais,
 tudo o que existe em nós, e ao redor de nós. E para que esta Consagração seja realmente eficaz e duradoura,
 renovamos hoje, aqui aos vossos pés, oh! Maria,
 as promessas do nosso batismo e da nossa primeira comunhão.
<br/>
<br/>
 Comprometemo-nos a professar, corajosamente e sempre,
 as verdades da fé, e a viver como católicos, submissos à sua Santidade,
 o Papa e aos Bispos em comunhão com ele. Comprometemo-nos a observar os Mandamentos de Deus e da Igreja,
 particularmente a santificação do Domingo. considerai e depois fazei o que Vos disser o Coração.
...
Sagrados corações de Jesus e Maria, a Vós me consagro,
 para sempre, minha pessoa e toda minha família.
 A Vós fazemos a entrega de tudo o que somos e de tudo o que nos pertence: nosso ser, nossa vida, nosso casa e nossapátria.
 Em vossa benignidade, dignai-vos aceitar este nosso humilde e sincero ato de Consagração,
 mediante o qual queremos esforçarmos em sermos fiéis cumpridores de vossa Santa Lei, vencendo toda classe de respeito humano. 
 Sob vosso amparo depositamos toda nossaesperança, seguros de vosso auxilio e benção.
<br/>
<br/>
Coração Sagrado de Jesus em Vós confio!
<br/>
<br/>
